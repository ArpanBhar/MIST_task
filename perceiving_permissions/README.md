...
### In this challenge we learnt how to set permissions (instead of appending them) using the "who=what,who=what" syntax
...
* the world does have write permissions
* the world does have execute permissions
hacker@permissions~permissions-setting-practice:~$ chmod u=rw,g=- /challenge/pwn
You set the correct permissions!
Round 2 (of 8)!
...
- the world doesn't have write permissions
- the world doesn't have execute permissions
hacker@permissions~permissions-setting-practice:~$ chmod g=-,o=- /challenge/pwn
You set the correct permissions!
Round 5 (of 8)!
...
- the world doesn't have write permissions
- the world doesn't have execute permissions
hacker@permissions~permissions-setting-practice:~$ chmod u=wx,g=wx,o=r /challenge/pwn
You set the correct permissions!
You've solved all 8 rounds! I have changed the ownership
of the /flag file so that you can 'chmod' it. You won't be able to read
it until you make it readable with chmod!
...
pwn.college{YROmYkDyD2-lr7sxXunkvCR6Jt7.dNTM5QDL1ATN0czW}
```

## the SUID bit

### In this challenge we learnt about the use of user-id

Setting user-id will enable a user to run the program as the owner of the file as long as the user as executable permission
...
pwn.college{EG-TzFi9eB2MtpzXqbbb_leth0w.dNTM2QDL1ATN0czW}
```